...
// Additional event, BeforeSelectionChanged implementation by Nathan Milot, u1063587 and Ismael Kadilo Wa Ngoie, u1120347
...
namespace SSGui
{
    ...
    /// <summary>
    /// The type of delegate used to register for BeforeSelectionChanged events
    /// </summary>
    /// <param name="e"></param>
    public delegate void BeforeSelectionChangedHandler(MouseEventArgs e);
    ...
    public partial class SpreadsheetPanel : UserControl
    {
        ...
        /// <summary>
        /// The event used to send notifications that the selection is about to be changed
        /// </summary>
        public event BeforeSelectionChangedHandler BeforeSelectionChanged;
        ...
        private class DrawingPanel : Panel
        {
            ...
            {
                if(_ssp.BeforeSelectionChanged != null) {
                    _ssp.BeforeSelectionChanged(e);
                }
                base.OnClick(e);
